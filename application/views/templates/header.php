...
<head>
  ...
  <meta content="Shri Dwarkadhish Testing Labs in Haldwani is dedicated to serve quality" name="description">
  <script type="text/javascript">
    let site_url_ = '<?php echo site_url(); ?>';
    let base_url_ = '<?php echo base_url(); ?>';
  </script>
  <!-- Favicons -->
